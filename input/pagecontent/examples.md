...
2. An imaging report with structured and unstructured elements ([link](./example-semi-structured.html))
3. An imaging report exploring many of the structured data elements ([link](./example-structured.html))
