...
<!-- FHIR version -->
{% assign BaseFHIRversion = {{site.data.fhir.version}} | split: '.' | first  %}
{% assign FHIRVersion = R4 %}

<!-- // Resources -->
{% if site.data.fhir.version == "4.0.1" %}
    {% assign Account  = "[`Account`](https://www.hl7.org/fhir/R4/composition.html)" %}
  {% assign ActivityDefinition = "[`ActivityDefinition`](https://www.hl7.org/fhir/R4/composition.html) %}
  ...
  {% assign ArtifactAssessment = "[`ArtifactAssessment`](https://www.hl7.org/fhir/R" | append: BaseFhirVersion | append: "/ArtifactAssessment.html)" %}
